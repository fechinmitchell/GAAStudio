...
function App() {
  ...
  useEffect(() => {
    ...
    if (selectedTeam && dataType) {
      ...
      setHeatMapUrl(`/datasets/${formattedDataType}/${selectedTeam}_${dataType}_heat_map.jpg`);
      /Users/fechinmitchell/Projects/GAAStudio/datasets/Miss/Galway_miss_heat_map.jpg
    }
}, [selectedTeam, dataType]);
