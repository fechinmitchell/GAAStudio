...
function App() {
  ...
  useEffect(() => {
    ...
    // This example assumes your server exposes the images at a URL pattern like /Users/fechinmitchell/Projects/GAAStudio/datasets/Shots/Galway_shots.jpg
    // Adjust the path as necessary to match your backend server's routing logic.
    if (selectedTeam && dataType) {
      const url = `/Users/fechinmitchell/Projects/GAAStudio/datasets/${selectedTeam}/${dataType}`;
      setHeatMapUrl(url);
    }
