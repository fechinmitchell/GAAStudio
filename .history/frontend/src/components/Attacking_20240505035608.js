...
function Attacking({ selectedTeam, scoringZoneEfficiency, heatMapUrl, setDataType }) {
  ...
  const [size, setSize] = useState({ width: 400, height: 200 });  // Initialize state for size
  ...
  return (
    <div className="content-container">
      <Resizable size={size} onResize={onResize} className="chart-container">
        <div>
          <Bar data={{
      ...
      <Resizable size={size} onResize={onResize} className="heatmap-container">
        <div>
      ...
      <Resizable size={size} onResize={onResize} className="fixed-table-container">
        <div>
