  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter the players based on the selected team
        const filteredPlayers = response.data.filter(player => player.TeamName === selectedTeam);
        setPlayerStats(filteredPlayers);
      } catch (error) {
