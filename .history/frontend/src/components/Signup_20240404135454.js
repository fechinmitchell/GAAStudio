...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // Assuming you want to save email and fullName at this point
      // Create a Firestore document for the signed-up user
      await setDoc(doc(firestore, "users", user.uid), {
        email: email,
        fullName: fullName,
        // profilePic: profilePicUrl, // You can add this line back if you decide to include profile picture upload functionality later
      });
