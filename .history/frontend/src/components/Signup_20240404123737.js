...
// import { getStorage, ref, uploadBytes, getDownloadURL } from "firebase/storage"; // Commented out since not using storage
import './AuthForm.css';
...
function SignUp() {
  ...
  // const [profilePic, setProfilePic] = useState(null); // Commented out profile picture state
  ...
  // const storage = getStorage(); // Commented out since not using storage
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      await setDoc(doc(firestore, "users", user.uid), {
        email,
        fullName,
        // profilePic: profilePicUrl // Commented out profilePic field
      });
    ...
    <div className="auth-form-container" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
      <form onSubmit={handleSignUp} className="auth-form">
        ...
        {/* <input
          ...
          required
        /> */} {/* Commented out profile picture input */}
        ...
        <button
            ...
            style={{ width: '100%' }} // Adjust vertical alignment here
          >
