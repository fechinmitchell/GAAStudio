...
function Attacking({ selectedTeam, scoringZoneEfficiency, heatMapUrl, setDataType }) {
  ...
  return (
    <div className="content-container">
      <Resizable className="chart-and-heatmap-container">
        <div>
          <Bar data={chartData} options={chartOptions} />
        </div>
      </Resizable>
      <Resizable className="heatmap-container">
        <div>
      ...
      <Resizable className="fixed-table-container">
        <div>
      ...
      <Resizable className="additional-chart-container">
        <div>
          <Image src={SDPMChartUrl} alt={`${selectedTeam} SDPM Chart`} fluid />
        </div>
      </Resizable>
      <Resizable className="additional-chart-container">
        <div>
          <Image src={ASDMapUrl} alt={`${selectedTeam} ASD Map`} fluid />
        </div>
      </Resizable>
    </div>
  );
