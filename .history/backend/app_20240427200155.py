...
def get_pressure_map(team):
    category = 'Pressure'  # Assuming pressure maps are stored under the 'Pressure' directory
    file_name = f"{team}_Pressure_Map.png"  # Adjust naming convention as necessary
