...
def get_scoring_zone_efficiency():
    ...
    try:
        # Load dataset from Firebase Storage
        df = download_file_from_firebase('backend/Football_Championship_2023_Shots_With_Expected_Points.json')
